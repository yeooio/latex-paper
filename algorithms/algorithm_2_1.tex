\begin{algorithm}[!htb]
\TableStyle
\caption{Screening procedure for candidate health indicators}
\label{alg:2-1}
\begin{tabularx}{\linewidth}{@{}p{0.09\linewidth}X@{}}
\toprule
行号 & 内容 \\
\midrule
...
11 & 计算 $f_i$ 与每个已入选指标 $f_s\in\mathcal{S}$ 的组平均绝对 PCC 和 SCC，分别记为 $\Phi_{\mathrm{PCC}}(i,s)$ 和 $\Phi_{\mathrm{SCC}}(i,s)$ \\
