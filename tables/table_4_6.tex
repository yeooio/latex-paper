...
\label{tab:4-6}
\begin{tabularx}{\linewidth}{@{\extracolsep{\fill}}L{0.85}L{1.55}R{0.90}R{0.90}R{0.90}R{0.90}@{}}
\toprule
Dataset & Method & \multicolumn{1}{c}{$R^2$} & \multicolumn{1}{c}{MAE} & \multicolumn{1}{c}{MAPE} & \multicolumn{1}{c}{RMSE} \\
\midrule
